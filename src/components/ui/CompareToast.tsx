...
export function CompareToast({ message, type, visible, onDismiss }: CompareToastProps) {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 z-[90] w-[calc(100vw-2rem)] max-w-md -translate-x-1/2 animate-[fadeSlideUp_0.3s_ease-out] sm:w-auto sm:max-w-none" role="status" aria-live="polite">
      <div className={`flex flex-wrap items-center justify-center gap-3 rounded-lg border px-4 py-3 text-center shadow-xl backdrop-blur-md sm:flex-nowrap sm:justify-start sm:text-left ${
        type === 'success'
